...
<head>
    ...
    <style>
        ...
        h1 { margin-top:0; text-align:center; color:#16a34a; }
        form { display:flex; flex-direction:column; gap:10px; margin-top:12px; }
        label { font-weight:600; }
        input[type="number"] { padding:8px; border-radius:4px; border:1px solid #d1d5db; }
        button { margin-top:4px; padding:10px; border:none; border-radius:6px; background:#22c55e; color:#fff; font-weight:600; cursor:pointer; }
        button:hover { background:#16a34a; }
        .result { margin-top:12px; padding:10px; border-radius:6px; background:#ecfdf5; border:1px solid #bbf7d0; }
