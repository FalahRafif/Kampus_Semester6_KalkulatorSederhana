...
1) Fokus di blok POST untuk melihat alur data dari form.
2) Semua fungsi calculator_* berasal dari includes/calculator_utils.php.
3) Jika ingin paham input dinamis (Tambah Input/Hapus), buka assets/js/app.js.
4) Untuk styling komponen form/riwayat, buka assets/css/app.css.
*/
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Jika validasi lolos, proses operasi pengurangan berurutan.
    // Implementasi perhitungan berurutan ada di helper bagian 'subtract'.
    if ($error === null) {
