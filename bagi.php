...
1) Ikuti blok POST untuk alur backend dari form sampai hasil.
2) Semua fungsi calculator_* ada di includes/calculator_utils.php.
3) Untuk input dinamis (Tambah/Hapus kolom), cek assets/js/app.js.
4) Untuk warna/tema/komponen, cek assets/css/app.css.
*/
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Jika validasi lolos, proses operasi pembagian berurutan.
    // Di helper bagian 'divide' juga ada pengecekan pembagi nol.
    if ($error === null) {
        $calculated = calculator_calculate('divide', $values);
        ...
        if ($error === null) {
            ...
            calculator_add_history('Pembagian', $expression, $hasilTeks);
        }
    }
}
