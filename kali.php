...
<head>
    ...
    <style>
        ...
        button { margin-top:4px; padding:10px; border:none; border-radius:6px; background:#3b82f6; color:#fff; font-weight:600; cursor:pointer; }
        button:hover { background:#1d4ed8; }
        .result { margin-top:12px; padding:10px; border-radius:6px; background:#eff6ff; border:1px solid #bfdbfe; }
